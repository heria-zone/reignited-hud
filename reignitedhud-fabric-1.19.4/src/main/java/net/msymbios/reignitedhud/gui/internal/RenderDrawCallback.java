...
public class RenderDrawCallback {
    ...
    public static void drawIcon(int posX, int posY, int row, int pos) {
        ...
        GuiComponent.blit(new PoseStack(), posX, posY, pos * 10 - 10, row * 10 - 10, 10, 10);
    } // drawIcon ()
    ...
    public static void drawMediumBar( int posX, int posY, int bar, float fill) {
        ...
        // Render the bar
        GuiComponent.blit(pose, posX, posY, 0, barNumber, 91, 5);

        // Render the filled portion of the bar based on the variable fill
        GuiComponent.blit(pose, posX + 1, posY + 1, 1, barNumberBG, (int)(fill * 89.0F), 3);
    } // drawMediumBar ()
    ...
    public static void drawLongBar(int posX, int posY, int bar, float var) {
        ...
        GuiComponent.blit(pose, posX, posY, 91, barNumber, 121, 5);

        // Draw the filled part of the bar based on the variation
        GuiComponent.blit(pose, posX + 1, posY + 1, 92, barNumberBG, (int)(var * 119.0F), 3);
    } // drawLongBar ()
    ...
    public static void drawDurabilityBar(int posX, int posY, int bar, float var) {
        ...
        GuiComponent.blit(pose, posX, posY, 212, 76 + barNumber, 37, 5);
        GuiComponent.blit(pose, posX + 1, posY + 1, 213, 76 + barNumberBG, (int)(var * 35.0F), 3);
    } // drawDurabilityBar ()
    ...
    public static void addDurabilityDisplay(ItemStack stack, int pos) {
        ...
        GuiComponent.blit(pose, 34, 11 + posY  + isdmgbl + pos + add, 49, 0, 39, 14);
        GuiComponent.blit(pose, 15, 10 + posY  + pos + add, 29, 0, 20, 20);
        minecraft.getItemRenderer().renderGuiItem(pose, stack, 17, 12 + posY  + pos + add);
