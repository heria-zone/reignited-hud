...
public class RenderDrawCallback {
     ...
     */
    public static void drawFont(GuiGraphics graphics, String string, int posX, int posY, int color) {
        ...
        graphics.drawString(font, string, posX, posY, color);
     ...
     */
    public static void drawFontWithShadow(GuiGraphics graphics, String string, int posX, int posY, int color, int shadow) {
        // Get the font renderer instance
        Font font = Minecraft.getInstance().font;
        // Draw the shadow of the string at an offset position
        graphics.drawString(font, string, (float)(posX + 1), (float)(posY + 1), shadow, false);
        // Draw the main text at the specified position
        graphics.drawString(font, string, (float)posX, (float)posY, color, false);
        // Reset the blend color
        GlStateManager._clearColor(1.0F, 1.0F, 1.0F, 1.0F);
    } // drawFontWithShadow ()
     ...
     */
    public static void drawFontWithShadow(GuiGraphics graphics, String text, int posX, int posY, int color) {
        // Get the font renderer instance
        Font font = Minecraft.getInstance().font;
        // Draw the text with shadow using the specified parameters
        graphics.drawString(font, text, (float)posX, (float)posY, color, true);
        // Reset the blend color
        GlStateManager._clearColor(1.0F, 1.0F, 1.0F, 1.0F);
    } // drawFontWithShadow ()
    ...
    public static void drawFontBold(GuiGraphics graphics, String text, int posX, int posY, int color, int shadow) {
        ...
        graphics.drawString(font, text, (float)(posX + 1), (float)posY, shadow, false);
        graphics.drawString(font, text, (float)(posX - 1), (float)posY, shadow, false);
        graphics.drawString(font, text, (float)posX, (float)(posY + 1), shadow, false);
        graphics.drawString(font, text, (float)posX, (float)(posY - 1), shadow, false);

        // Draw the main text
        graphics.drawString(font, text, (float)posX, (float)posY, color, false);
     ...
     * @param shadow the color of the shadow
     */
    public static void drawFontWithShadowRightAligned(GuiGraphics graphics, String text, int posX, int posY, int color, int shadow) {
        ...
        drawFontWithShadow(graphics, text, newX, posY, color, shadow);
     ...
     * @param shadow the color of the shadow
     */
    public static void drawFontWithShadowCentered(GuiGraphics graphics, String text, int posX, int posY, int color, int shadow) {
        // Calculate the new x-coordinate position for right alignment
     ...
     */
    public static void drawFontBoldCentered(GuiGraphics graphics, String text, int posX, int posY, int color, int shadow) {
        ...
        drawFontBold(graphics, text, newX, posY, color, shadow);
    ...
    public static void drawMediumBar(ResourceLocation icon, GuiGraphics graphics, int posX, int posY, int bar, float fill) {
        ...
        // Render the bar
        graphics.blit(icon, posX, posY, 0, barNumber, 91, 5);

        // Render the filled portion of the bar based on the variable fill
        graphics.blit(icon, posX + 1, posY + 1, 1, barNumberBG, (int)(fill * 89.0F), 3);
    } // drawMediumBar ()
    ...
    public static void drawLongBar(ResourceLocation icon, GuiGraphics graphics, int posX, int posY, int bar, float var) {
        ...
        graphics.blit(icon, posX, posY, 91, barNumber, 121, 5);

        // Draw the filled part of the bar based on the variation
        graphics.blit(icon, posX + 1, posY + 1, 92, barNumberBG, (int)(var * 119.0F), 3);
    } // drawLongBar ()
    ...
    public static void drawDurabilityBar(ResourceLocation icon, GuiGraphics graphics, int posX, int posY, int bar, float var) {
        ...
        graphics.blit(icon, posX, posY, 212, 76 + barNumber, 37, 5);
        graphics.blit(icon, posX + 1, posY + 1, 213, 76 + barNumberBG, (int)(var * 35.0F), 3);
    } // drawDurabilityBar ()
     ...
     */
    public static void addDurabilityDisplay(GuiGraphics graphics, ItemStack stack, int pos) {
