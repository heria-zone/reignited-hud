...
public class RenderDrawCallback {
    ...
    public static void drawFontWithShadow(String string, int posX, int posY, int color, int shadow) {
        ...
        font.drawShadow(pose, string, (float)(posX + 1), (float)(posY + 1), shadow, false);
        // Draw the main text at the specified position
        font.drawShadow(pose, string, (float)posX, (float)posY, color, false);
        // Reset the blend color
        GlStateManager._clearColor(1.0F, 1.0F, 1.0F, 1.0F);
    } // drawFontWithShadow ()
    ...
    public static void drawFontWithShadow(String text, int posX, int posY, int color) {
        ...
        font.drawShadow(pose, text, (float)posX, (float)posY, color, true);
        // Reset the blend color
        GlStateManager._clearColor(1.0F, 1.0F, 1.0F, 1.0F);
    } // drawFontWithShadow ()
    ...
    public static void addDurabilityDisplay(ItemStack stack, int pos) {
        ...
        minecraft.gui.blit(new PoseStack(), 34, 61 + isdmgbl + pos + add, 49, 0, 39, 14);
        minecraft.gui.blit(new PoseStack(), 15, 60 + pos + add, 29, 0, 20, 20);
        minecraft.getItemRenderer().renderGuiItem(new PoseStack(), stack, 17, 62 + pos + add);
